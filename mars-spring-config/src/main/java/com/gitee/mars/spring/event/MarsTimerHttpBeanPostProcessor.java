...
import com.gitee.mars.spring.api.CheckForUpdateVo;
import com.gitee.mars.spring.api.ForDataVo;
import com.gitee.mars.spring.config.GlobalMarsProperties;
import com.gitee.mars.spring.config.MarsDataConfig;
import com.gitee.mars.spring.enums.ApiResultEnum;
import com.gitee.mars.spring.enums.ConfigTypeEnum;
import com.gitee.mars.spring.env.MarsPropertySource;
import com.gitee.mars.spring.server.ServerHttpAgent;
import com.gitee.mars.spring.util.BeanUtil;
import com.gitee.mars.spring.util.PropertiesSourceUtil;
import com.gitee.mars.spring.util.StringUtil;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        executorService = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("com.gitee.mars.spring.event.MarsTimerHttpBeanPostProcessor");
                t.setDaemon(true);
                return t;
            }
        });
